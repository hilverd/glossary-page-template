module Components.Badge exposing (withRemoveButton)
...
withRemoveButton onClick additionalAttributes children =
    span
        (class "inline-flex items-center max-w-xs gap-x-0.5 rounded-full border border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-900 px-2 py-1 text-gray-700 dark:text-gray-200 shadow-xs" :: additionalAttributes)
        [ span
