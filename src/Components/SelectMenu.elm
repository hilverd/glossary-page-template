...
render properties choices =
    ...
    div
        ...
        [ select
            ...
            , class "mt-1 block w-full truncate pl-3 pr-10 py-2 dark:bg-gray-700 dark:text-gray-200 border-gray-300 dark:border-gray-500 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 rounded-md"
